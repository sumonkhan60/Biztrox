...
<head>
  ...
  <!-- animate -->
  <link rel="stylesheet" href="{{asset('/')}}frontend-assets/plugins/animate/animate.css">
  <!-- Aos -->
  <link rel="stylesheet" href="{{asset('/')}}frontend-assets/plugins/aos/aos.css">
  <!-- swiper -->
  <link rel="stylesheet" href="{{asset('/')}}frontend-assets/plugins/swiper/swiper.min.css">
  <!-- Stylesheets -->
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="mb-5 mb-md-0 text-center text-md-left">
            <!-- logo -->
            <img class="mb-30" src="{{asset('/frontend-assets')}}/images/logo-footer.png" alt="logo">
...
<!-- filter -->
<script src="{{asset('/')}}frontend-assets/plugins/filterizr/jquery.filterizr.min.js"></script>
<!-- Google Map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5nZKbeK-WHQ70oqOWo-_4VmwOwKP9YQ"></script>
<script  src="{{asset('/')}}frontend-assets/plugins/google-map/gmap.js"></script>
<!-- Syo Timer -->
<script src="{{asset('/')}}frontend-assets/plugins/syotimer/jquery.syotimer.js"></script>
<!-- aos -->
