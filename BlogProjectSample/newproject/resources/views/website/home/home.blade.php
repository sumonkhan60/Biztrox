...
<section>
  <div class="hero-slider position-relative">
    <div class="hero-slider-item py-160" style="background-image: url({{asset('/frontend-assets')}}/images/banner/banner-1.jpg);"
    ...
    <div class="hero-slider-item py-160" style="background-image: url({{asset('/frontend-assets')}}/images/banner/banner-2.jpg);"
    ...
    <div class="hero-slider-item py-160" style="background-image: url({{asset('/frontend-assets')}}/images/banner/banner-3.jpg);" data-icon="ti-money"
      data-text="Finance">
      <div class="container">
        <div class="row">
          <div class="col-12">
    ...
    <div class="hero-slider-item py-160" style="background-image: url({{asset('/frontend-assets')}}/images/banner/banner-4.jpg);"
...
<section class="about section-sm overlay" style="background-image: url({{asset('/frontend-assets')}}/images/background/about-bg.jpg);">
    <div class="container">
        <div class="row">
    ...
    <div class="row work-slider">
      <div class="col-lg-3 px-0">
        <div class="work-slider-image">
          <img class="img-fluid w-100" src="{{asset('/frontend-assets')}}/images/works/work-1.jpg" alt="work-image">
          <div class="image-overlay">
            <a class="popup-image" data-effect="mfp-zoom-in" href="{{asset('/frontend-assets')}}/images/works/work-1.jpg">
              <i class="ti-search"></i>
            </a>
...
<section class="mission section">
  <div class="container">
    <div class="row">
      ...
      <!-- chart -->
      <div class="col-lg-6">
        <img src="{{asset('/frontend-assets')}}/images/chart.png" alt="chart" class="img-fluid w-100">
      </div>
    </div>
  </div>
</section>
...
<!-- promo-video -->
<section class="promo-video overlay section" style="background-image: url({{asset('/frontend-assets')}}/images/background/promo-video.jpg);">
  <div class="container">
    <div class="row">
      <div class="col-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 pr-0 align-self-center">
                <img class="img-fluid w-100" src="{{asset('/frontend-assets')}}/images/client.png" alt="clients-image">
            </div>
...
<section class="cta overlay-primary py-50 text-center text-lg-left" style="background-image: url({{asset('/frontend-assets')}}/images/background/cta.jpg);">
        <div class="container">
  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
        <div class="card">
          <div class="card-img-wrapper overlay-rounded-top">
            <img class="card-img-top" src="{{asset('/frontend-assets')}}/images/blog/blog-1.jpg" alt="blog-thumbnail">
          </div>
          <div class="card-body p-0">
            <div class="d-flex">
      ...
      <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
        <div class="card">
          <div class="card-img-wrapper overlay-rounded-top">
            <img class="card-img-top" src="{{asset('/frontend-assets')}}/images/blog/blog-2.jpg" alt="blog-thumbnail">
          </div>
          <div class="card-body p-0">
            <div class="d-flex">
              <div class="py-3 px-4 border-right text-center">
  ...
  <div class="container">
    <div class="client-logo-slider align-self-center">
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-1.png" alt="client-logo"></a>
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-2.png" alt="client-logo"></a>
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-3.png" alt="client-logo"></a>
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-4.png" alt="client-logo"></a>
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-5.png" alt="client-logo"></a>
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-1.png" alt="client-logo"></a>
      <a href="#" class="text-center d-block outline-0 py-3 px-2"><img class="d-unset"
          src="{{asset('/frontend-assets')}}/images/client-logo/client-logo-2.png" alt="client-logo"></a>
